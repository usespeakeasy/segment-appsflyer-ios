...
# AppsFlyer integration for Segment - Speak iOS Integration

## Speak iOS Custom Implementation
### 🔧 Adaptation Changes
- **Public Headers and Include Directory**: The SPM package has been configured to use an `include` directory for public headers.
- **Package Dependencies**: The package has been updated to depend on:
  - `analytics-ios` (as product "Segment") - This is a customized version of analytics-ios located at `https://github.com/usespeakeasy/analytics-ios`
  - `AppsFlyerLib`

### 📦 Dependency Status
This library is a core dependency for the Speak iOS application. It handles all AppsFlyer attribution tracking and deep linking within the app.

### ⚙️ Integration Notes
- Do not update this library without thorough testing of attribution tracking in the main application
- The main Speak app relies on specific deep linking functionality provided by this library
- Any changes to this dependency may affect attribution reporting across the entire application
